...
local event = ReplicatedStorage:WaitForChild("LolaTrigger")
local player = game.Players.LocalPlayer
local camera = workspace.CurrentCamera

event.OnClientEvent:Connect(function()
	local playerGui = player:WaitForChild("PlayerGui")
	local turonGui = playerGui:WaitForChild("LolaTriggerGui")
	local frame = turonGui:WaitForChild("Frame")
	local textLabel = frame:WaitForChild("TextLabel")
	local cameraFocus = workspace:WaitForChild("Games"):WaitForChild("Lakbay Pamana"):WaitForChild("CameraFocusLola")

	-- Show GUI
	turonGui.Enabled = true
	frame.Visible = true
	textLabel.Visible = true
	textLabel.Text = "Kausapin si Lola. Kailangan niya ng tulong mo."
