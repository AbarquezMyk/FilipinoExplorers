...
local event = ReplicatedStorage:WaitForChild("SipaKoseTrigger")
local player = game.Players.LocalPlayer
local camera = workspace.CurrentCamera

event.OnClientEvent:Connect(function()
	local playerGui = player:WaitForChild("PlayerGui")
	local turonGui = playerGui:WaitForChild("SipaTriggerGui")
	local frame = turonGui:WaitForChild("Frame")
	local textLabel = frame:WaitForChild("TextLabel")
	local cameraFocus = workspace:WaitForChild("Games"):WaitForChild("Lakbay Pamana"):WaitForChild("CameraFocusKose")

	-- Show GUI
	turonGui.Enabled = true
	frame.Visible = true
	textLabel.Visible = true
	textLabel.Text = "Kausapin si Kose. Kailangan niya ng tulong mo."
